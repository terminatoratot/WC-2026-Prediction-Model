...
class StrongWorldCupModel:
    def __init__(
        ...
        # v14 player-data hook. When set by V14PlayerModel, it is a callable
        # (lam_a, lam_b, team_a, team_b) -> (lam_a', lam_b', info_dict) applied at
        # the lambda stage so individual-player strength can shift expected goals
        # asymmetrically (a team's attack vs the opponent's defence).
        self.player_lambda_adjuster = None
    ...
    def predict(self, team_a, team_b, host_a=False, host_b=False, knockout=False, max_goals=10):
        ...
        player_adjustment = {}
        if self.player_lambda_adjuster is not None:
            corrected_a, corrected_b, player_adjustment = self.player_lambda_adjuster(
                corrected_a, corrected_b, team_a, team_b
            )
